...
const items = [
  ...
  { id: 3, color: "var(--warning)", label: "Officer Vehicle", image: "/assets/vehicles/officer/normal.png" },
];
    ...
    <div className="tech-grid-bg" style={{ background: 'var(--background)' }}>
      ...
      <div id="example">
        ...
        <section className="intro-section">
          <h1 className="impact" style={{ margin: 0, padding: 0 }}>
            <VedaLogo height="1em" className="logo-3d" />
          </h1>
          <div className="text-2xl text-glow" style={{ marginTop: '2rem', letterSpacing: '0.15em', fontWeight: 800, textAlign: 'center' }}>
            VEHICLE EVALUATION AND DIAGNOSTIC AGENT
          </div>
          <p className="text-xl text-secondary" style={{ marginTop: '1rem', maxWidth: '700px', lineHeight: '1.8' }}>
